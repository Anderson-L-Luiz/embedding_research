...
audio_files = [
    "/home/anderson/audio_embedding_research/Signals/Bdb001/Bdb001.interaction.wav",
    "/home/anderson/audio_embedding_research/Signals/Bed002/Bed002.interaction.wav",
    "/home/anderson/audio_embedding_research/Signals/Bed003/Bed003.interaction.wav",
    "/home/anderson/audio_embedding_research/Signals/Bed004/Bed004.interaction.wav",
]
...
# Save audio significance values
with open(os.path.join(experiment_folder, "audio_significance.npy"), "wb") as f:
    np.save(f, np.array(audio_significance))

# Save text significance values
with open(os.path.join(experiment_folder, "text_significance.npy"), "wb") as f:
    np.save(f, np.array(text_significance))

# Save mean significance values
mean_significance_data = {
    "mean_audio_significance": mean_audio_significance,
    "mean_text_significance": mean_text_significance
}

with open(os.path.join(experiment_folder, "mean_significance.json"), "w") as f:
    json.dump(mean_significance_data, f, indent=2)
